        ...
        <CardHeader>
          <div className="flex items-center gap-2">
            {logoBroken ? (
              ...
              <img
                src="/images/logo-pactadoc.png"
                alt="PactaDoc"
                className="w-10 h-10 rounded-lg bg-primary/10 object-contain p-1"
                onError={() => setLogoBroken(true)}
              />
            )}
            <div>
              <CardTitle className="font-display text-xl">PactaDoc</CardTitle>
